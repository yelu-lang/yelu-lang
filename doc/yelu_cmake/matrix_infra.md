...
1. **I/O-free callback discipline** — `Cmake_bridge` provides
   ...
   the runner does. See
   [io_architecture.md § 3](io_architecture.md#3-the-callback-via-env-pattern).
...
- [io_architecture.md](io_architecture.md) — the library/runner
  split this whole thing depends on
- [status.md](status.md) — what's still deferred and what's
  loader-stub-only
- [doc/cmake/cache_semantics.md](../cmake/cache_semantics.md) —
