...
- **Bar #3-lite static round-trip — shipped, audit-ready.** STRUCT=0 /
  ...
  [`parse_print_oracle.md`](../probes/methodology/parse_print_oracle.md); milestone arc in
...
Static round-trip is at a natural stop ([`parse_print_oracle.md`](../probes/methodology/parse_print_oracle.md) § 10).
...
above; per-parser detail in `probes/methodology/parse_print_oracle.md` § 8). The two sets
