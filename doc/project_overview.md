...
- **fmt predictor probe complete.** ✅ Shipped 2026-06-03. 24-cell matrix
  ...
  Audit-ready writeup at [`probes/fmt.md`](probes/fmt.md).
...
| `probes/fmt.md`            | fmt probe status — 24/24 cells perfect; adaptation footprint.      |
| `probes/fmt_probe_report.md`      | fmt 2026-06-01 pre-implementation scoping (SUPERSEDED banner).     |
| `probes/z3.md`             | z3 probe — 108/108 parse-print OK; matrix not yet built.           |
| `probes/llvm.md`           | llvm probe — 3004/3035 parse-print OK; matrix not yet built.       |
