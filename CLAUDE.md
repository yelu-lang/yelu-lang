...
| `doc/yelu_cmake/pipelines.md`         | Complete text↔IR survey: every reader, writer, converter, evaluator, and composed pipeline between cmake / yc / ycn. Lists what exists and what doesn't. |
