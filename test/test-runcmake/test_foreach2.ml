...
let zip_three =
  check_cmake "zip_three" (ESeq [
    yc_set (ycvar "as") [ystr "a"; ystr "b"];
    yc_set (ycvar "bs") [ystr "1"; ystr "2"];
    yc_set (ycvar "cs") [ystr "x"; ystr "y"];
    yc_set (ycvar "result") [];
    yc_foreach_zip [ycvar "a"; ycvar "b"; ycvar "c"] [ycvar "as"; ycvar "bs"; ycvar "cs"] (ESeq [
